      ...
      services={[
        {
          ...
          description:
            "Machine learning algorithms that identify emerging search patterns and opportunities",
          features: [
          ...
          icon: Brain,
          resultMetric:
            "340% more high-opportunity keywords identified vs traditional research",
        },
        {
          name: "Content Relevance Optimization",
          slug: "content-relevance-optimization",
          description:
            "Optimize content for AI understanding and featured snippet capture",
          features: [
        ...
        },
        {
          ...
          description:
            "Forecast ranking opportunities and algorithm changes before they happen",
          features: [
        ...
        },
        {
          ...
          description:
            "Maximize visibility across all search formats and AI-powered results",
          features: [
      ...
      processSteps={[
        {
          ...
          description:
            "Analyze current performance across AI-powered search platforms and identify opportunities.",
          icon: Search,
        },
        {
          step: "02",
          ...
          description:
            "Create comprehensive AI search strategy aligned with emerging search behaviors.",
          icon: Brain,
        },
        {
          step: "03",
          ...
          description:
            "Optimize content for AI understanding, featured snippets, and voice search.",
          icon: Target,
        },
        {
          step: "04",
          ...
          description:
            "Track performance across all search formats and continuously adapt strategy.",
          icon: BarChart3,
        },
      ]}
      categoryBenefits={[
