      ...
      services={[
        {
          ...
          description:
            "Deep market insights and competitive intelligence to inform strategy",
          features: [
        ...
        },
        {
          ...
          description:
            "Comprehensive marketing strategies with clear roadmaps and objectives",
          features: [
          ...
          icon: Target,
          resultMetric:
            "156% improvement in marketing ROI through strategic planning",
        },
        {
          name: "Analytics & Reporting",
          slug: "analytics-reporting",
          description:
            "Advanced analytics setup and performance monitoring systems",
          features: [
        ...
        },
        {
          ...
          description:
            "Systematic testing and optimisation to improve conversion performance",
          features: [
      ...
      processSteps={[
        {
          ...
          description:
            "Gather comprehensive data from all marketing channels and customer touchpoints.",
          icon: BarChart3,
        },
        {
          step: "02",
          ...
          description:
            "Analyse data to identify patterns, opportunities, and strategic recommendations.",
          icon: Lightbulb,
        },
        {
          step: "03",
          ...
          description:
            "Develop actionable strategies based on data insights and business objectives.",
          icon: Target,
        },
        {
          step: "04",
          ...
          description:
            "Execute strategies with continuous monitoring and performance optimisation.",
          icon: Zap,
        },
      ]}
      categoryBenefits={[
