  ...
  return (
    <ServicePageTemplate
      ...
      serviceFeatures={[
        {
          ...
          description:
            "Comprehensive email marketing strategy aligned with business objectives",
          icon: Target,
        },
        {
          title: "Automated Drip Campaigns",
          description:
            "Sophisticated email sequences that nurture prospects through the buyer's journey",
          icon: Zap,
        },
        {
          title: "Behavioural Triggers",
          description:
            "Smart automation based on website behaviour, email engagement, and purchase history",
          icon: Brain,
        },
        {
          title: "List Segmentation",
          description:
            "Advanced segmentation for personalised messaging and improved relevance",
          icon: Users,
        },
        {
          title: "Performance Analytics",
          description:
            "Detailed tracking and optimisation based on engagement and conversion data",
          icon: BarChart3,
        },
        {
      ...
      processSteps={[
        {
          ...
          description:
            "Analyse current email performance and develop comprehensive automation strategy",
        },
        {
          step: "02",
          title: "Sequence Design & Setup",
          description:
            "Create automated email sequences and set up behavioural triggers",
        },
        {
          step: "03",
        ...
        },
        {
          ...
          description:
            "Monitor performance and continuously optimise for better results",
        },
      ]}
      resultMetrics={[
        {
      ...
      caseStudy={{
        ...
        challenge:
          "High-quality leads were going cold between initial contact and sales conversations, resulting in lost opportunities and frustrated sales team.",
        result:
          "Implemented sophisticated email nurturing sequences that resulted in 78% more qualified prospects reaching sales conversations and 45% higher close rates.",
        metric: "78% More Qualified Prospects",
      }}
      investmentInfo={{
        description:
          "Email marketing automation investment depends on list size and complexity of sequences. Most businesses see ROI within 2-3 months through improved conversion rates.",
      ...
      faqs={[
        {
          ...
          answer:
            "We follow email deliverability best practices including proper authentication, list hygiene, engagement monitoring, and gradual sending volume increases. We also help you maintain good sender reputation through quality content and list management.",
        },
        {
          question: "Can you integrate with our existing CRM system?",
          answer:
            "Yes, we integrate with all major CRM platforms including Salesforce, HubSpot, Pipedrive, and many others. This ensures seamless data flow between your email marketing and sales processes.",
        },
        {
          question: "How do you personalise emails at scale?",
          answer:
            "We use advanced segmentation, dynamic content, and behavioural triggers to personalise emails based on demographics, interests, behaviour, and purchase history. This creates relevant experiences for each recipient.",
        },
        {
          question: "What metrics do you track to measure success?",
          answer:
            "We track open rates, click-through rates, conversion rates, unsubscribe rates, and most importantly, revenue attribution. We also monitor email deliverability and list growth metrics.",
        },
      ]}
      relatedServices={[
        {
          ...
          description:
            "Create valuable content to feed your email marketing campaigns",
        },
        {
          name: "CRM Automation",
          slug: "../../ai-automation/intelligence/crm-automation",
          description:
            "Integrate email automation with comprehensive CRM systems",
        },
        {
          name: "Analytics & Reporting",
          slug: "../../strategy/analytics-reporting",
          description:
            "Track and analyse email performance alongside other marketing channels",
        },
      ]}
    />
  );
