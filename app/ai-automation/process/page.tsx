      ...
      services={[
        {
          ...
          description:
            "Intelligent automation that transforms operations and eliminates manual bottlenecks",
          features: [
        ...
        },
        {
          ...
          description:
            "Streamlined workflows that improve efficiency and reduce operational complexity",
          features: [
        ...
        },
        {
          ...
          description:
            "Automated quality assurance and compliance monitoring systems",
          features: [
        ...
        },
        {
          ...
          description:
            "Intelligent task prioritisation and automated assignment systems",
          features: [
        ...
        },
        {
          ...
          description:
            "Seamless integration that connects all your business systems",
          features: [
      ...
      processSteps={[
        {
          ...
          description:
            "Analyse current workflows and identify automation opportunities.",
          icon: BarChart3,
        },
        {
          step: "02",
          ...
          description:
            "Design custom automation solutions tailored to your specific needs.",
          icon: Target,
        },
        {
          step: "03",
          ...
          description:
            "Deploy and integrate automation systems with minimal disruption.",
          icon: Cog,
        },
        {
          step: "04",
          title: "Optimisation",
          description:
            "Monitor performance and continuously improve automation effectiveness.",
          icon: TrendingUp,
        },
      ]}
      categoryBenefits={[
