...
import { ArrowRight, Download, FileText, Video, Headphones, BookOpen, Zap } from "lucide-react"
      ...
      items: [
        {
          ...
          description: "A comprehensive 50-page guide covering everything from strategy development to execution and measurement.",
          type: "PDF Guide",
          downloadLink: "#",
          featured: true
        },
        {
          ...
          description: "Step-by-step checklist for implementing AI automation in your business processes.",
          type: "PDF Checklist",
          downloadLink: "#"
        },
        {
          title: "SEO Strategy Template for Small Businesses",
          description: "Ready-to-use template for developing your SEO strategy with keyword research and content planning.",
          type: "Template",
          downloadLink: "#"
        }
      ]
      ...
      items: [
        {
          ...
          description: "Calculate the return on investment for your marketing activities with our interactive tool.",
          type: "Online Tool",
          downloadLink: "#"
        },
        {
          title: "Content Calendar Template",
          description: "12-month content planning template with built-in social media scheduling.",
          type: "Excel Template",
          downloadLink: "#"
        },
        {
          title: "Email Marketing Audit Checklist",
          description: "Comprehensive checklist to audit and improve your email marketing performance.",
          type: "PDF Checklist",
          downloadLink: "#"
        }
      ]
      ...
      items: [
        {
          ...
          description: "See how our intelligent chatbot handles customer inquiries and routing in real-time.",
          type: "Video (12 min)",
          downloadLink: "#"
        },
        {
          title: "Growth Marketing Case Study Walkthrough",
          description: "Detailed walkthrough of how we achieved 340% traffic growth for a manufacturing client.",
          type: "Video (18 min)",
          downloadLink: "#"
        },
        {
          title: "SEO Strategy Planning Workshop",
          description: "Complete workshop recording on developing a winning SEO strategy for your business.",
          type: "Video (45 min)",
          downloadLink: "#"
        }
      ]
      ...
      items: [
        {
          ...
          description: "Expert discussion on how AI is transforming small business operations and customer experiences.",
          type: "Podcast (30 min)",
          downloadLink: "#"
        },
        {
          title: "Growth Marketing Trends 2025",
          description: "Live webinar covering the latest trends and strategies in growth marketing for the year ahead.",
          type: "Webinar (60 min)",
          downloadLink: "#"
        }
      ]
      ...
      <section className="bg-gradient-to-br from-midnight-blue via-forest-green to-coral-red text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <Badge className="bg-white/20 text-white mb-6">Free Resources</Badge>
            <h1 className="text-4xl lg:text-5xl font-heading font-bold mb-6">
              Everything You Need to <span className="text-coral-red">Grow Your Business</span>
            </h1>
            <p className="text-xl font-body mb-8 leading-relaxed opacity-90">
              Access our library of guides, templates, tools, and insights to accelerate
              your growth marketing and AI automation journey.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl font-body text-gray-600 max-w-3xl mx-auto">
              From comprehensive guides to practical tools, find exactly what you need
          ...
          <div className="space-y-16">
            {resources.map((category, categoryIndex) => (
              <div key={`category-${categoryIndex}-${category.category.replace(/\s+/g, '-').toLowerCase()}`}>
                  ...
                  {category.items.map((item, itemIndex) => (
                    <Card
                      ...
                      className={`shadow-lg hover:shadow-xl transition-shadow duration-300 ${
                        item.featured ? 'border-2 border-coral-red' : 'border-gray-200'
                      }`}
                    >
                      {item.featured && (
                      ...
                      <CardContent>
                        <Button asChild variant="outline" className="w-full border-coral-red text-coral-red hover:bg-coral-red hover:text-white">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white rounded-2xl shadow-2xl p-8 lg:p-12">
            ...
            <p className="text-lg font-body text-gray-600 mb-8 max-w-2xl mx-auto">
              Subscribe to our newsletter and be the first to access new guides, templates,
              and tools as soon as we release them.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl font-body text-gray-600 max-w-3xl mx-auto">
              Discover how our clients have used these resources to achieve remarkable results.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-gradient-to-br from-forest-green to-midnight-blue text-white shadow-lg">
              <CardHeader>
                <Badge className="bg-white/20 text-white w-fit">Case Study</Badge>
                <CardTitle className="text-xl font-heading">
                  How TechFlow Used Our SEO Template
                </CardTitle>
                <CardDescription className="text-white/80">
                  See how a software company achieved 245% traffic growth using our SEO strategy template.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button asChild variant="outline" className="border-white text-white hover:bg-white hover:text-forest-green">
            ...
            <Card className="bg-gradient-to-br from-coral-red to-forest-green text-white shadow-lg">
              <CardHeader>
                <Badge className="bg-white/20 text-white w-fit">Success Story</Badge>
                <CardTitle className="text-xl font-heading">
                  Manufacturing Company's AI Transformation
                </CardTitle>
                <CardDescription className="text-white/80">
                  Learn how our AI implementation guide helped save 45+ hours per week in manual tasks.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button asChild variant="outline" className="border-white text-white hover:bg-white hover:text-coral-red">
                  <Link href="/case-studies">
                    View Success Story
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
      ...
      <section className="py-20 bg-midnight-blue text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl font-body mb-8 opacity-90">
            While our resources provide valuable insights, nothing beats personalised guidance.
