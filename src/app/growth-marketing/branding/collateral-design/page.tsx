  ...
  return (
    <ServicePageTemplate
      ...
      serviceFeatures={[
        {
          ...
          description:
            "Professional business cards, letterheads, and corporate stationery",
          icon: FileText,
        },
        {
          title: "Marketing Brochures & Flyers",
          description:
            "Compelling print materials that communicate value and drive action",
          icon: Eye,
        },
        {
          title: "Digital Graphics & Assets",
          description:
            "Social media graphics, email templates, and digital marketing assets",
          icon: Palette,
        },
        {
          title: "Presentation Templates",
          description:
            "Professional presentation designs for sales and marketing teams",
          icon: Target,
        },
        {
          title: "Trade Show Materials",
          description:
            "Exhibition stands, banners, and promotional materials for events",
          icon: Award,
        },
        {
      ...
      processSteps={[
        {
          ...
          description:
            "Understand requirements, audience, and brand guidelines for each project",
        },
        {
          step: "02",
          title: "Concept Development",
          description:
            "Create initial design concepts and layouts for client review",
        },
        {
          step: "03",
          title: "Design Refinement",
          description:
            "Refine designs based on feedback and finalise all materials",
        },
        {
          step: "04",
          title: "Production & Delivery",
          description:
            "Prepare print-ready files and coordinate production if required",
        },
      ]}
      resultMetrics={[
        {
      ...
      caseStudy={{
        ...
        challenge:
          "Inconsistent marketing materials were undermining their premium positioning and making it difficult to compete for high-value contracts.",
        result:
          "Complete collateral redesign resulted in 34% increase in proposal success rate, 67% more meeting requests, and unanimous feedback about improved professional perception.",
        metric: "34% Proposal Success Increase",
      }}
      investmentInfo={{
        description:
          "Collateral design investment varies based on quantity and complexity of materials required. Most projects deliver immediate impact on professional perception and marketing effectiveness.",
        startingFrom: "£2,500",
      ...
      faqs={[
        {
          ...
          answer:
            "We design all types of marketing materials including business cards, brochures, flyers, presentations, trade show materials, digital assets, packaging, and any other branded collateral your business requires.",
        },
        {
          question: "Do you handle printing and production?",
          answer:
            "We can coordinate printing and production through our trusted supplier network, ensuring quality control and competitive pricing. Alternatively, we provide print-ready files for your preferred suppliers.",
        },
        {
          question: "How do you ensure brand consistency across all materials?",
          answer:
            "We work from your existing brand guidelines or help develop them if needed. All designs are created within a systematic approach that ensures consistent use of colours, fonts, imagery, and messaging.",
        },
        {
          question: "Can you create templates for our internal team to use?",
          answer:
            "Yes, we specialise in creating template systems that allow your team to produce on-brand materials efficiently whilst maintaining design quality and brand consistency.",
        },
      ]}
      relatedServices={[
        {
          ...
          description:
            "Develop comprehensive brand guidelines that inform all collateral design",
        },
        {
        ...
        },
        {
          ...
          description:
            "Create compelling content to populate your marketing materials",
        },
      ]}
    />
  );
