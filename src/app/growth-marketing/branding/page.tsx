...
import { Palette, Globe, TrendingUp, Target, Users, Eye, Zap, Award } from "lucide-react"
      ...
      services={[
        {
          ...
          description: "Strategic brand positioning and visual identity that resonates with your audience",
          features: [
        ...
        },
        {
          ...
          description: "Professional marketing materials and creative assets that convert",
          features: [
        ...
        },
        {
          ...
          description: "Conversion-optimised websites that combine beautiful design with performance",
          features: [
        ...
        },
        {
          ...
          description: "Strategic customer journey design that maximises conversions",
          features: [
      ...
      processSteps={[
        {
          ...
          description: "Understand your business, audience, and competitive landscape to inform strategy.",
          icon: Eye
        },
        {
          step: "02",
          title: "Strategy & Positioning",
          description: "Develop brand positioning and messaging that differentiates and resonates.",
          icon: Target
        },
        {
          step: "03",
          title: "Creative Development",
          description: "Design and create brand assets and marketing materials that convert.",
          icon: Palette
        },
        {
          step: "04",
          title: "Implementation & Optimisation",
          description: "Launch brand assets and continuously optimise for better performance.",
          icon: Zap
        }
      ]}
