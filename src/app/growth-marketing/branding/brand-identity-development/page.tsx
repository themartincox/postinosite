...
import { Award, Target, BarChart3, TrendingUp, Palette, Eye, Users, Heart } from "lucide-react"
    ...
    <ServicePageTemplate
      ...
      serviceFeatures={[
        {
          ...
          description: "Comprehensive brand strategy that defines your unique market position",
          icon: Target
        },
        {
          title: "Visual Identity System",
          description: "Logo design, colour palette, typography, and visual brand guidelines",
          icon: Palette
        },
        {
          title: "Brand Messaging Framework",
          description: "Core messaging, value propositions, and tone of voice development",
          icon: Users
        },
        {
          title: "Brand Guidelines Creation",
          description: "Comprehensive style guides for consistent brand application",
          icon: Eye
        },
        {
          title: "Brand Application Design",
          description: "Business cards, letterheads, and marketing collateral design",
          icon: Award
        },
        {
          title: "Brand Performance Monitoring",
          description: "Track brand awareness, perception, and recognition metrics",
          icon: BarChart3
        }
      ]}
      ...
      processSteps={[
        ...
        },
        {
          ...
          description: "Design logo, visual elements, and comprehensive brand guidelines"
        },
        {
          step: "04",
          title: "Implementation & Launch",
          description: "Apply brand across all touchpoints and monitor performance"
        }
      ]}
      ...
      caseStudy={{
        ...
        challenge: "Struggling to differentiate from competitors and command premium pricing despite superior quality and service in the engineering sector.",
        result: "Developed compelling brand identity and positioning strategy that resulted in 34% increase in average project value, 67% more premium enquiries, and recognition as industry leaders.",
        metric: "34% Pricing Increase"
      }}

      investmentInfo={{
        description: "Brand identity development is a one-time investment that creates long-term value. Investment varies based on scope and complexity of brand requirements.",
        startingFrom: "£8,500",
      ...
      faqs={[
        {
          ...
          answer: "Typically 6-12 weeks depending on scope and complexity. This includes research, strategy development, design creation, revisions, and final brand guidelines delivery."
        },
        {
          question: "What's included in the brand guidelines?",
          answer: "Comprehensive brand guidelines include logo usage, colour specifications, typography, imagery style, tone of voice, messaging framework, and application examples across various media."
        },
        {
          question: "Can you refresh our existing brand rather than start from scratch?",
          answer: "Absolutely. We offer brand evolution services that modernise and strengthen existing brands whilst maintaining equity and recognition you've already built."
        },
        {
          question: "How do you ensure our brand stands out from competitors?",
          answer: "We conduct thorough competitive analysis and market research to identify differentiation opportunities, then develop unique positioning and visual identity that clearly sets you apart."
        }
      ]}
      ...
      relatedServices={[
        {
          ...
          description: "Apply your new brand identity to a conversion-optimised website"
        },
        {
          name: "Collateral & Design",
          slug: "collateral-design",
          description: "Create marketing materials that reinforce your brand identity"
        },
        {
          name: "Marketing Planning",
          slug: "../../strategy/marketing-planning",
          description: "Develop marketing strategies that leverage your brand positioning"
        }
      ]}
    />
  )
