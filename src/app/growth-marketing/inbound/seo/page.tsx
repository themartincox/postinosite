  ...
  return (
    <ServicePageTemplate
      ...
      serviceFeatures={[
        {
          ...
          description:
            "Comprehensive analysis of site structure, speed, and technical performance",
          icon: Search,
        },
        {
          title: "AI-Driven Keyword Research",
          description:
            "Machine learning algorithms identify high-opportunity keywords",
          icon: Target,
        },
        {
        ...
        },
        {
          ...
          description:
            "Dominate local search results and Google Business Profile",
          icon: Users,
        },
        {
          title: "Performance Tracking",
          description:
            "Advanced analytics and reporting on rankings and traffic",
          icon: TrendingUp,
        },
      ]}
      processSteps={[
        {
          ...
          description:
            "Comprehensive technical audit, keyword research, and competitor analysis",
        },
        {
          step: "02",
          title: "Strategy Development",
          description:
            "Custom SEO strategy aligned with business objectives and market opportunities",
        },
        {
          step: "03",
          title: "Implementation & Optimisation",
          description:
            "Execute technical fixes, content creation, and link building campaigns",
        },
        {
          step: "04",
          title: "Monitoring & Refinement",
          description:
            "Continuous monitoring, reporting, and strategy refinement for growth",
        },
      ]}
      resultMetrics={[
        {
      ...
      caseStudy={{
        ...
        challenge:
          "Struggling with low online visibility and losing potential customers to competitors who ranked higher in search results.",
        result:
          "Achieved 340% increase in organic traffic, 23 first-page rankings for target keywords, and 89% more qualified enquiries within 8 months.",
        metric: "340% Traffic Growth",
      }}
      investmentInfo={{
        description:
          "Our SEO services are designed for businesses serious about long-term organic growth. Investment varies based on competition level and scope.",
      ...
      faqs={[
        {
          ...
          answer:
            "Most clients see initial improvements within 3-4 months, with significant results typically achieved within 6-8 months. SEO is a long-term strategy that builds compound growth over time.",
        },
        {
          question: "What makes your SEO approach different?",
          answer:
            "We combine traditional SEO expertise with AI-powered insights to identify opportunities others miss. Our approach focuses on sustainable, white-hat techniques that deliver lasting results.",
        },
        {
          question: "Do you guarantee specific rankings?",
          answer:
            "While we can't guarantee specific rankings (no ethical SEO company can), we do guarantee improved organic visibility, traffic growth, and enhanced search performance based on our proven methodology.",
        },
        {
          question: "How do you measure SEO success?",
          answer:
            "We track rankings, organic traffic, click-through rates, and most importantly, business metrics like leads and conversions generated from organic search.",
        },
      ]}
      relatedServices={[
        {
          ...
          description:
            "Strategic content creation that supports SEO and engages your audience",
        },
        {
          name: "Email Marketing",
          slug: "email-marketing",
          description:
            "Nurture organic traffic through automated email sequences",
        },
        {
          name: "Social Media Marketing",
          slug: "social-media",
          description:
            "Amplify your content reach through social media channels",
        },
      ]}
    />
  );
