      ...
      services={[
        {
          ...
          slug: "seo",
          description:
            "AI-enhanced search engine optimisation that dominates organic rankings",
          features: [
          ...
          icon: Search,
          resultMetric:
            "Average 285% increase in organic traffic within 6 months",
        },
        {
          name: "Content Strategy & Creation",
          slug: "content-strategy-creation",
          description:
            "Strategic content that educates, engages, and converts prospects",
          features: [
          ...
          icon: PenTool,
          resultMetric:
            "340% improvement in content engagement and lead generation",
        },
        {
          name: "Email Marketing Automation",
          slug: "email-marketing-automation",
          description:
            "Nurture sequences that guide prospects through the buyer's journey",
          features: [
        ...
        },
        {
          ...
          description:
            "Build community and drive engagement across social platforms",
          features: [
      ...
      processSteps={[
        {
          ...
          description:
            "Deep analysis of your target audience, their pain points, and content preferences.",
          icon: Users,
        },
        {
          step: "02",
          ...
          description:
            "Create comprehensive inbound strategy aligned with business objectives.",
          icon: Target,
        },
        {
          step: "03",
          ...
          description:
            "Develop valuable content that attracts and engages your ideal prospects.",
          icon: PenTool,
        },
        {
          step: "04",
          ...
          description:
            "Continuously improve performance and scale successful initiatives.",
          icon: TrendingUp,
        },
      ]}
      categoryBenefits={[
