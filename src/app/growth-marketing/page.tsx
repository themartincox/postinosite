...
import { ArrowRight, Search, PenTool, Mail, Share2, BarChart3, Target, TrendingUp, Users, Globe, MessageSquare, Eye } from "lucide-react"
      ...
      <section className="bg-forest-green text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <Badge className="bg-white/20 text-white mb-6">Growth Marketing Services</Badge>
            ...
            <p className="text-xl font-body mb-8 leading-relaxed opacity-90">
              From comprehensive SEO strategies to compelling content creation, our growth marketing services
              are designed to build sustainable, scalable growth for ambitious SMEs. Every campaign is data-driven,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl font-body text-gray-600 max-w-3xl mx-auto">
              Our growth marketing approach is built on four interconnected pillars,
              each enhanced by AI insights and proven methodologies.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <Card className="bg-white shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-forest-green">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-forest-green/5 p-4 rounded-lg">
                  <h5 className="font-heading font-semibold text-forest-green mb-2">AI-Enhanced Features:</h5>
                  <ul className="text-sm font-body text-gray-600 space-y-1">
                    <li>• Intelligent keyword targeting and content gaps analysis</li>
            ...
            <Card className="bg-white shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-coral-red">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-coral-red/5 p-4 rounded-lg">
                  <h5 className="font-heading font-semibold text-coral-red mb-2">Results You Can Expect:</h5>
                  <ul className="text-sm font-body text-gray-600 space-y-1">
            ...
            <Card className="bg-white shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-midnight-blue">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-midnight-blue/5 p-4 rounded-lg">
                  <h5 className="font-heading font-semibold text-midnight-blue mb-2">Creative Excellence:</h5>
                  <ul className="text-sm font-body text-gray-600 space-y-1">
            ...
            <Card className="bg-white shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-forest-green">
              ...
              <CardContent className="space-y-6">
                ...
                <Separator />
                <div className="bg-forest-green/5 p-4 rounded-lg">
                  <h5 className="font-heading font-semibold text-forest-green mb-2">Strategic Value:</h5>
                  <ul className="text-sm font-body text-gray-600 space-y-1">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl font-body text-gray-600 max-w-3xl mx-auto">
              Every successful growth strategy follows a systematic approach. Here's how we ensure
              your marketing investment delivers measurable, sustainable results.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Deep dive into your business, market, and current performance to identify opportunities.",
                icon: Search
              },
              {
                step: "02",
                title: "Strategy Development",
                description: "Create a comprehensive, data-driven growth strategy tailored to your unique goals.",
                icon: Target
              },
              {
                step: "03",
                title: "Implementation & Execution",
                description: "Deploy campaigns and initiatives with precision, monitoring performance at every step.",
                icon: TrendingUp
              },
              {
                step: "04",
                title: "Optimization & Scaling",
                description: "Continuously refine and scale successful initiatives for maximum growth impact.",
                icon: BarChart3
              }
            ].map((item, index) => (
              <div key={item.step} className="text-center">
                ...
                <div className="text-3xl font-heading font-bold text-coral-red mb-2">{item.step}</div>
      ...
      <section className="py-20 bg-forest-green text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl font-body mb-8 opacity-90">
            Let's discuss how our growth marketing expertise can transform your business.
            Book a free consultation to explore your opportunities.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild variant="outline" size="lg" className="border-white hover:bg-white hover:text-forest-green bg-white/5">
              <Link href="/ai-automation" className="text-coral-red hover:text-forest-green">
                <span className="font-heading font-semibold">Explore AI Automation Services</span>
