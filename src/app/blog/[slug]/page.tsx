...
import { ArrowLeft, ArrowRight, Calendar, Clock, User, Share2, BookOpen, TrendingUp } from "lucide-react"
      ...
      <div className="bg-soft-gray py-4">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <Link href="/blog" className="hover:text-midnight-blue transition-colors">Blog</Link>
            <span className="mx-2">/</span>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <Badge className="bg-coral-red text-white mb-4">{post.category}</Badge>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
              <div className="flex flex-wrap gap-2">
                <span className="text-sm font-heading font-semibold text-gray-600">Tags:</span>
                {post.tags.map((tag) => (
      ...
      <section className="py-16 bg-midnight-blue text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl font-body mb-8 opacity-90">
            Let's discuss how our AI-enhanced growth strategies can help you achieve
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild variant="outline" size="lg" className="border-white hover:bg-white hover:text-midnight-blue bg-white/5">
              <Link href="/blog" className="text-coral-red hover:text-midnight-blue">
