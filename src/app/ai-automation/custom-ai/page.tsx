      ...
      services={[
        {
          ...
          description:
            "Intelligent conversational AI that handles customer service and lead qualification",
          features: [
        ...
        },
        {
          ...
          description:
            "Custom machine learning models that forecast trends and optimise decisions",
          features: [
        ...
        },
        {
          ...
          description:
            "AI-powered lead qualification and intelligent routing to sales teams",
          features: [
      ...
      processSteps={[
        {
          ...
          description:
            "Deep dive into your business needs and AI opportunity assessment.",
          icon: Target,
        },
        {
          step: "02",
          ...
          description:
            "Design custom AI architecture tailored to your specific requirements.",
          icon: Brain,
        },
        {
          step: "03",
          ...
          description:
            "Build and train AI models using your business data and use cases.",
          icon: Cog,
        },
        {
          step: "04",
          ...
          description:
            "Deploy AI solutions and continuously optimise for better performance.",
          icon: TrendingUp,
        },
      ]}
      categoryBenefits={[
