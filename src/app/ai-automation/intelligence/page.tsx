...
import { Database, BarChart3, Users, Target, Brain, TrendingUp, Eye, Zap } from "lucide-react"
      ...
      services={[
        {
          ...
          description: "AI-powered predictive models that forecast trends and opportunities",
          features: [
        ...
        },
        {
          ...
          description: "Intelligent customer grouping for personalized marketing and sales",
          features: [
        ...
        },
        {
          ...
          description: "AI-powered personalization engines for marketing and sales communications",
          features: [
      ...
      processSteps={[
        {
          ...
          description: "Connect and consolidate data from all business systems and touchpoints.",
          icon: Database
        },
        {
          step: "02",
          title: "AI Model Development",
          description: "Build custom AI models tailored to your specific business needs and goals.",
          icon: Brain
        },
        {
          step: "03",
          title: "Insight Generation",
          description: "Deploy AI systems that continuously analyse data and generate insights.",
          icon: TrendingUp
        },
        {
          step: "04",
          title: "Automation & Optimisation",
          description: "Automate insight delivery and continuously improve model performance.",
          icon: Zap
        }
      ]}
