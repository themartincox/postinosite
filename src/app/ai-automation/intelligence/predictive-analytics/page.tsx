  ...
  return (
    <ServicePageTemplate
      ...
      faqs={[
        ...
        {
          question:
            "What data do you need to build effective prediction models?",
          answer:
        ...
        {
          question:
            "How accurate are the predictions, and how do you measure success?",
          answer:
        ...
        {
          question:
            "Can predictive analytics integrate with our existing business systems?",
          answer:
