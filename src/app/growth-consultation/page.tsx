        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl font-body mb-8 leading-relaxed opacity-90">
              Get a comprehensive business audit, custom growth strategy, and
              clear roadmap for the next 6-12 months. Our expert strategists
              will identify your biggest opportunities and create an actionable
            ...
            <div className="inline-flex items-center bg-coral-red/20 border border-coral-red/30 px-6 py-3 rounded-full mb-8">
              ...
              <span className="text-sm opacity-90">
                Fully refunded on first project invoice
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl font-body text-gray-600 max-w-3xl mx-auto">
              A comprehensive 60-minute strategic session designed to identify
              your biggest growth opportunities and create a clear action plan.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="bg-white shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent>
                <p className="font-body text-gray-600 text-sm">
                  Tailored growth recommendations based on your industry,
            ...
            <Card className="bg-white shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent>
                <p className="font-body text-gray-600 text-sm">
                  Deep dive into what your competitors are doing and how to gain
            ...
            <Card className="bg-white shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent>
                <p className="font-body text-gray-600 text-sm">
                  Clear, prioritised roadmap with specific actions for the next
                  6-12 months.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl font-body text-gray-600 max-w-3xl mx-auto">
              Our proven process ensures you get maximum value from your
              strategic session.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="font-body text-gray-600">
                Complete our strategic questionnaire and share key business
                information so we can prepare tailored insights for your
                session.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="font-body text-gray-600">
                60-minute intensive session covering business audit, strategy
                development, and actionable recommendations tailored to your
                specific situation.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="font-body text-gray-600">
                Receive a detailed strategy document, recommended tools list,
                and priority action items to implement immediately.
              </p>
            </div>
          </div>
        </div>
          ...
          <Card className="bg-white shadow-2xl border-0">
            ...
            <CardContent className="p-8">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <p className="font-body text-gray-600 text-sm">
                        <strong>100% refundable</strong> against your first
                        project invoice when you decide to work with us
                      </p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-forest-green mt-1 flex-shrink-0" />
                      <p className="font-body text-gray-600 text-sm">
                        Deters time-wasters and ensures we're both serious about
                    ...
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-forest-green mt-1 flex-shrink-0" />
                      <p className="font-body text-gray-600 text-sm">
                        Guarantees you receive our full attention and premium
                        preparation
                      </p>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="font-body text-gray-600">
                        <strong>Format:</strong> Video call (Zoom/Teams)
                      </span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Award className="h-5 w-5 text-coral-red" />
                      <span className="font-body text-gray-600">
                        <strong>Follow-up:</strong> Strategy document included
                      </span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Lightbulb className="h-5 w-5 text-coral-red" />
                      <span className="font-body text-gray-600">
                        <strong>Focus:</strong> Actionable growth strategies
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-8 text-center">
                <Button
                  size="lg"
                  className="bg-coral-red hover:bg-coral-red/90 text-white px-8 py-4 text-lg"
                >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl font-body text-gray-600 max-w-3xl mx-auto">
              Our growth strategy sessions are designed for serious business
              leaders ready to invest in growth.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={`perfect-${index}-${item.slice(0, 20)}`}
            ...
            <div>
              <h3 className="text-2xl font-heading font-bold text-coral-red mb-6">
                Not Right If You:
              </h3>
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={`not-right-${index}-${item.slice(0, 20)}`}
                    className="flex items-start space-x-3"
                  >
            ...
            {[
              {
                ...
                answer:
                  "The £50 fee ensures we're both serious about the session and allows us to dedicate proper preparation time. It's fully refunded when you become a client, so there's no real cost if we work together.",
              },
              {
                question:
                  "What if I don't proceed with Postino after the session?",
                answer:
                  "That's perfectly fine! You'll still receive tremendous value from the session itself. The £50 investment covers our strategic expertise and the detailed follow-up documentation you'll receive.",
              },
              {
                question: "How quickly can we schedule the session?",
                answer:
                  "Most sessions can be scheduled within 3-5 business days. After payment, you'll receive a calendar link to book a time that works for both of us.",
              },
              {
                question: "What preparation is required?",
                answer:
                  "We'll send you a strategic questionnaire to complete before the session. This helps us understand your business and prepare relevant insights and recommendations.",
              },
              {
                question: "Will you share specific tactics during the session?",
                answer:
                  "The session focuses on strategic direction and identifying opportunities. While we'll share some tactical insights, detailed implementation guides are part of our ongoing client work.",
              },
            ].map((faq, index) => (
              <Card
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl font-body text-gray-600 mb-8">
              Join the growing number of SME leaders who've transformed their
              businesses with strategic guidance. Book your session today and
