        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-5xl font-heading font-bold mb-6">
              Investment Plans That Drive{" "}
              <span className="text-coral-red">Real Results</span>
            </h1>
            <p className="text-xl font-body mb-8 leading-relaxed opacity-90">
              Choose the right combination of growth marketing and AI automation
              services to transform your business. All plans include dedicated
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <Card className="border-2 border-forest-green shadow-lg">
              <CardHeader className="text-center">
                <Badge className="bg-forest-green text-white mx-auto mb-4">
                  Most Popular
                </Badge>
            ...
            <Card className="border-2 border-coral-red shadow-lg">
              <CardHeader className="text-center">
                <Badge className="bg-coral-red text-white mx-auto mb-4">
                  High ROI
                </Badge>
                <CardTitle className="text-2xl font-heading text-midnight-blue">
                  AI Automation
                ...
                <div className="mt-6">
                  <span className="text-4xl font-heading font-bold text-coral-red">
                    £15,000
                  </span>
            ...
            <Card className="border-2 border-midnight-blue shadow-lg relative">
              ...
              <CardHeader className="text-center pt-8">
                ...
                <div className="mt-6">
                  <span className="text-4xl font-heading font-bold text-midnight-blue">
                    £35,000
                  </span>
                  <span className="text-gray-600">/project</span>
                </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="h-5 w-5 text-midnight-blue flex-shrink-0" />
                    <span className="font-body text-gray-700">
                      12 months ongoing optimisation
                    </span>
                  </div>
                </div>
                <Button
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <Card className="bg-white shadow-md">
              ...
              <CardContent>
                <p className="font-body text-gray-600">
                  Yes, we create bespoke pricing for enterprise clients and
                  large-scale transformations. Contact us to discuss your
                  specific requirements and receive a custom proposal.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white shadow-md">
              ...
              <CardContent>
                <p className="font-body text-gray-600">
                  All plans include email support, monthly performance reviews,
                  strategy adjustments, and access to our client portal with
            ...
            <Card className="bg-white shadow-md">
              ...
              <CardContent>
                <p className="font-body text-gray-600">
                  We track measurable efficiency gains and cost savings. If you
                  don't see positive ROI within 12 months, we'll refund the
                  difference or continue working until you do.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 bg-midnight-blue text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl font-body mb-8 opacity-90">
            Book a consultation to discuss your specific needs and receive a
            custom proposal tailored to your business objectives and budget.
          </p>
